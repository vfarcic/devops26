...
Pod Template:
  Labels:           app=gcactivities
                    release=jenkins-x
  Service Account:  jenkins-x-gcactivities
  Containers:
   gcactivities:
    Image:      jenkinsxio/jx:1.3.976
    Port:       <none>
    Host Port:  <none>
    Command:
      jx
    ...
    Mounts:          <none>
  Volumes:           <none>
Last Schedule Time:  Fri, 15 Mar 2019 22:30:00 +0100
Active Jobs:         <none>
Events:              <none>
```
...
Pod Template:
  Labels:           app=gcpods
                    release=jenkins-x
  Service Account:  jenkins-x-gcpods
  Containers:
   gcpods:
    Image:      jenkinsxio/jx:1.3.976
    Port:       <none>
...
Namespace:                  jx
Labels:                     app=gcpreviews
                            chart=gcpreviews-1.3.976
                            heritage=Tiller
                            release=jenkins-x
Annotations:                <none>
Schedule:                   0 */3 * * *
...
Pod Template:
  ...
  Containers:
   gcpreviews:
    Image:      gcr.io/jenkinsxio/builder-go:0.1.286
    Port:       <none>
    Host Port:  <none>
    Command:
      jx
    ...
    Mounts:          <none>
  Volumes:           <none>
Last Schedule Time:  Fri, 15 Mar 2019 22:00:00 +0100
Active Jobs:         <none>
Events:              <none>
```
