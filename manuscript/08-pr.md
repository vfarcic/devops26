...
W> Please execute the commands that follow only if you restored a branch at the beginning of a chapter (like in the snippet above). Please note the comments within the snippet that follows.
