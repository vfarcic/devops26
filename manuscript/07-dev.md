...
W> Since April 2019, creating DevPods fails. You will likely experience problems until the [issue 3689](https://github.com/jenkins-x/jx/issues/3689) is resolved. Feel free to skip this chapter if the issue is still open. If you do, the next chapter contains the command that will create the files you'd do here in the master branch of *go-demo-6*.
