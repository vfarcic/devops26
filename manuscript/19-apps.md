...
* Create a new **AKS** cluster created **without the Boot**: [aks-jx-serverless.sh](https://gist.github.com/b07f45f6907c2a1c71f45dbe0df8d410)
* Use an **existing** cluster created **without the Boot**: [install-serverless.sh](https://gist.github.com/7b3b3d90ecd7f343effe4fff5241d037)
